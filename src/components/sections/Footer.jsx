...
const Footer = () => {
  return (
    ...
    <div className="flex justify-center gap-10 sm:gap-16 lg:gap-0">
        <GsapMagnetic>
          <svg className='lg:h-[150px] lg:p-[50px] cursor-pointer fill-current  h-[50px] ' id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.5 58">
        ...
        <GsapMagnetic>
          <svg className='lg:h-[150px] lg:p-[50px] cursor-pointer fill-current  h-[50px] ' id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56.13 46.08">
        ...
        <GsapMagnetic>
          <svg className='lg:h-[150px] lg:p-[50px] cursor-pointer fill-current  h-[50px] ' id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 51.1 36.69">
        ...
        <GsapMagnetic>
          <svg className='lg:h-[150px] lg:p-[50px] cursor-pointer fill-current  h-[50px] ' id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47.26 53.87">
